...
MAX_ALLOWED_RADIUS_SENSOR = 10.0 # 10
...
class NextRoute(Exception):
    """
    Exceptions thrown when the route is terminated by the reward function. Used to move to the next route without reset.
    """
    pass
...
class AgentWrapper(object):
    ...
    def setup_sensors(self, vehicle):
        ...
        if len(sensors) > 0:
            ...
            # NOTE for performance reasons we should tune this if using sensors.
