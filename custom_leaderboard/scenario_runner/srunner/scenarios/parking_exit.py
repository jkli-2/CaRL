...
class ParkingExit(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        # NOTE relies on CARLA tick in request_new_actor
        # x = self.ego_vehicles[0].get_location()
        # if x.distance(self._ego_location) > 3.0:
        #     raise ValueError("Couldn't spawn the ego vehicle")
