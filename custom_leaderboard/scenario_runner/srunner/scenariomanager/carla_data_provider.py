...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    def get_map_route():
        """
        @return the route stored as map waypoints.
        """
        return CarlaDataProvider._map_route

    @staticmethod
    def set_map_route(map_route):
        """
        @return the route stored as map waypoints.
        """
        CarlaDataProvider._map_route = map_route
    @staticmethod
    def get_random_seed():
        """
    ...
    def cleanup():
        ...
        CarlaDataProvider._map_route.clear()
        CarlaDataProvider._actor_velocity_map.clear()
        CarlaDataProvider._actor_location_map.clear()
        CarlaDataProvider._actor_transform_map.clear()
        CarlaDataProvider._traffic_light_map.clear()
        CarlaDataProvider._vehicles_with_open_doors.clear()
    ...
    def cleanup_route():
        """
        Cleanup and remove all entries from all dictionaries except for the elements that stay the same if the town is
        not changed.
        """
        DestroyActor = carla.command.DestroyActor  # pylint: disable=invalid-name
        batch = []
