...
class EMA:
  """
  Class for computing double exponential running mean (Holt's linear trend method).
  """

  def __init__(self, initial, alpha=0.3):
    """
    Initialize DoubleExponentialMean reducer.
