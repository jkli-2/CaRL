...
ENTRY_STATUS_VALUES = ['Started', 'Finished', 'Rejected', 'Crashed', 'Invalid', 'Simulation crashed']
ELIGIBLE_VALUES = {'Started': False, 'Finished': True, 'Rejected': False, 'Crashed': False, 'Invalid': False, 'Simulation crashed': False}
...
class StatisticsManager(object):
    ...
    def set_scenario(self, scenario, route_length=None):
    ...
    def compute_route_statistics(self, route_date_string, route_index, duration_time_system=-1, duration_time_game=-1, failure_message=""):
        ...
        # Commented out unecessary info for efficiency
        # score_penalty = 1.0
        # score_route = 0.0
        # for event_name in PENALTY_NAME_DICT.values():
