...
from carl_nuplan.planning.simulation.planner.pdm_planner.abstract_pdm_planner import (
    AbstractPDMPlanner,
)
from carl_nuplan.planning.simulation.planner.pdm_planner.observation.pdm_observation import (
    PDMObservation,
)
from carl_nuplan.planning.simulation.planner.pdm_planner.proposal.batch_idm_policy import (
    BatchIDMPolicy,
)
from carl_nuplan.planning.simulation.planner.pdm_planner.proposal.pdm_generator import (
    PDMGenerator,
)
from carl_nuplan.planning.simulation.planner.pdm_planner.proposal.pdm_proposal import (
    PDMProposalManager,
)
from carl_nuplan.planning.simulation.planner.pdm_planner.scoring.pdm_scorer import (
    PDMScorer,
)
from carl_nuplan.planning.simulation.planner.pdm_planner.simulation.pdm_simulator import (
    PDMSimulator,
)
from carl_nuplan.planning.simulation.planner.pdm_planner.utils.pdm_emergency_brake import (
    PDMEmergencyBrake,
)
...
class AbstractPDMClosedPlanner(AbstractPDMPlanner):
    ...
    def _get_closed_loop_trajectory(
        ...
        trajectory = self._emergency_brake.brake_if_emergency(ego_state, proposal_scores, self._scorer)
