...
from carl_nuplan.planning.simulation.planner.pdm_planner.utils.graph_search.bfs_roadblock import (
...
def get_current_roadblock_candidates(
    ...
    roadblock_dict: Dict[SemanticMapLayer, RoadBlockGraphEdgeMapObject] = get_proximal_map_objects(
        map_patch=ego_state.car_footprint.geometry, map_api=map_api, layers=layers
    )
    roadblock_candidates = (
...
def route_roadblock_correction_v2(
    ego_state: EgoState,
    map_api: AbstractMap,
