...
def _compute_lon_acceleration(states: npt.NDArray[np.float64], time_steps_s: npt.NDArray[np.float64]) -> WithinBound:
    """
...
def _compute_lat_acceleration(states: npt.NDArray[np.float64], time_steps_s: npt.NDArray[np.float64]) -> WithinBound:
    """
...
def _compute_jerk_metric(states: npt.NDArray[np.float64], time_steps_s: npt.NDArray[np.float64]) -> WithinBound:
    """
...
def _compute_lon_jerk_metric(states: npt.NDArray[np.float64], time_steps_s: npt.NDArray[np.float64]) -> WithinBound:
    """
...
def _compute_yaw_accel(states: npt.NDArray[np.float64], time_steps_s: npt.NDArray[np.float64]) -> WithinBound:
    """
...
def _compute_yaw_rate(states: npt.NDArray[np.float64], time_steps_s: npt.NDArray[np.float64]) -> WithinBound:
    """
